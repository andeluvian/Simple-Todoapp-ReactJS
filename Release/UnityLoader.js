function CompatibilityCheck() {
    hasWebGL
        ? mobile
            ...
            : -1 == browser.indexOf("Firefox") && -1 == browser.indexOf("Chrome") && -1 == browser.indexOf("Safari") && (confirm("Please note that your browser is not currently supported for this Unity WebGL content. Try installing Firefox, or press Ok if you wish to continue anyway.") || window.history.back())
...
function UnityErrorHandler(e, t, n) {
    return Module.errorhandler && Module.errorhandler(e, t, n) || (console.log("Invoking error handler due to\n" + e), "function" == typeof dump && dump("Invoking error handler due to\n" + e), didShowErrorMessage || -1 != e.indexOf("UnknownError") || -1 != e.indexOf("Program terminated with exit(0)"))
        ? void 0
        : (didShowErrorMessage = !0, -1 != e.indexOf("DISABLE_EXCEPTION_CATCHING")
            ? void alert("An exception has occurred, but exception handling has been disabled in this build. If you are the developer of this content, enable exceptions in your project's WebGL player settings to be able to catch the exception or see the stack trace.")
            : -1 != e.indexOf("Cannot enlarge memory arrays")
                ...
                : -1 != e.indexOf("Invalid array buffer length") || -1 != e.indexOf("Invalid typed array length") || -1 != e.indexOf("out of memory")
                    ...
                    : void alert("An error occurred running the Unity content on this page. See your browser's JavaScript console for more info. The error was:\n" + e))
}
...
function demangleError(e) {
    var t = -1 != browser.indexOf("Chrome")
    ...
    return e.replace(n, function(e) {
        var t = e.match(o),
            ...
            a = i && Module.blobInfo && Module.blobInfo[i[1]] && Module.blobInfo[i[1]].url
                ? Module.blobInfo[i[1]].url
                : "blob";
        return t[1] + n + (t[2] != n
            ? " [" + t[2] + "]"
            : "") + " (" + (i
            ? a.substr(a.lastIndexOf("/") + 1) + i[2]
            : t[7]) + ")"
    })
}
...
function LoadJSCode(e, t, n) {
    if (!Math.fround && n && "asmUrl" == n.id) {
        ...
        for (var o = {
            ...
            "EMSCRIPTEN_START_ASM", "EMSCRIPTEN_START_FUNCS", "EMSCRIPTEN_END_FUNCS"
        ], a = "var", r = "global.Math.fround;", s = 0, d = o.LOOKING_FOR_MODULE, l = 0, u = 0; d <= o.SCANNING_MODULE_FUNCTIONS && s < e.length; s++)
            if (47 == e[s] && 47 == e[s + 1] && 32 == e[s + 2] && String.fromCharCode.apply(null, e.subarray(s + 3, s + 3 + i[d].length)) === i[d])
                d++;
            else if (d != o.SCANNING_MODULE_VARIABLES || u || 61 != e[s] || String.fromCharCode.apply(null, e.subarray(s + 1, s + 1 + r.length)) !== r) {
                if (u && 40 == e[s]) {
                    for (var c = 0; u > c && e[s - 1 - c] == e[l - c];)
                        c++;
                    if (c == u) {
                        var f = e[s - 1 - c];
...
function DecompressAndLoadFile(e, t, n) {
    ...
    o.onload = function() {
        var n = new Uint8Array(o.response),
            ...
            r = (new Date).getTime();
        console.log("Decompressed " + e + " in " + (r - i) + "ms. You can remove this delay if you configure your web server to host files using " + window.unityDecompressReleaseFileExtension + " compression."),
        t(a)
    },
    o.onerror = function() {
        console.log("Could not download " + e),
        didShowErrorMessage || 0 != document.URL.indexOf("file:") || (alert("It seems your browser does not support running Unity WebGL content from file:// urls. Please upload it to an http server, or try a different browser."), didShowErrorMessage = !0)
    },
    o.send(null)
}
function LoadCompressedFile(e, t, n) {
    ...
    o.onprogress = function(e) {
        n && n(e),
        CompressionState.current == CompressionState.Pending && (0 == o.status || 200 == o.status
...
function SetIndexedDBAndLoadCompressedJS(e) {
    SetIndexedDBAndLoadCompressedJS.called || (SetIndexedDBAndLoadCompressedJS.called = !0, Module.indexedDB = e, Module.wasmBinaryFile && "object" == typeof Wasm
                    ...
                    for (i = 0, n = 0; s > n;)
                        if (a = e[n++], 128 > a)
                            ...
                            r > 1
                                ...
                                : 65536 > a
                                    ? l[i++] = a
                                    : (a -= 65536, l[i++] = 55296 | a >> 10 & 1023, l[i++] = 56320 | 1023 & a)
                        }
                    return o(l, i)
                },
                    ...
                    e : do
                    {
                        ...
                        t : for (;;) {
                            if (_ = y >>> 24, p >>>= _, b -= _, _ = y >>> 16 & 255, 0 === _)
                                ...
                                S = 65535 & y,
                                _ &= 15,
                                _ && (_ > b && (p += E[a++] << b, b += 8), S += p & (1 << _) - 1, p >>>= _, b -= _),
                                15 > b && (p += E[a++] << b, b += 8, p += E[a++] << b, b += 8),
                                y = g[p & k];
                                n : for (;;) {
        ...
        8: [
            function(e, t, n) {
                ...
                function a(e) {
                    var t;
                    return e && e.state
                        ? (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = 1 & t.wrap), t.mode = O, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = new w.Buf32(me), t.distcode = t.distdyn = new w.Buf32(pe), t.sane = 1, t.back = -1, D)
                        : L
                }
                function r(e) {
                    var t;
                ...
                function s(e, t) {
                    ...
                    return e && e.state
                        ? (o = e.state, 0 > t
                            ? (n = 0, t = -t)
                            : (n = (t >> 4) + 1, 48 > t && (t &= 15)), t && (8 > t || t > 15)
                            ? L
                            : (null !== o.window && o.wbits !== t && (o.window = null), o.wrap = n, o.wbits = t, r(e)))
                        : L
                }
                function d(e, t) {
                    var n,
                        o;
                    return e
                        ? (o = new i, e.state = o, o.window = null, n = s(e, t), n !== D && (e.state = null), n)
                        : L
                }
                function l(e) {
                    return d(e, we)
                ...
                function u(e) {
                    if (ge) {
                        var t;
                        for (p = new w.Buf32(512), b = new w.Buf32(32), t = 0; 144 > t;)
                            e.lens[t++] = 8;
                        for (; 256 > t;)
                            e.lens[t++] = 9;
                        for (; 280 > t;)
                ...
                function c(e, t, n, o) {
                    ...
                    o >= a.wsize
                        ...
                        : (i = a.wsize - a.wnext, i > o && (i = o), w.arraySet(a.window, t, n - o, i, a.wnext), o -= i, o
                ...
                function f(e, t) {
                    ...
                    e : for (;;)
                        switch (n.mode) {
                            ...
                            case Z:
                                ...
                                n.mode = P;
                            case P:
                                if (1024 & n.flags && (b = n.length, b > d && (b = d), b && (n.head && (_e = n.head.extra_len - n.length, n.head.extra || (n.head.extra = new Array(n.head.extra_len)), w.arraySet(n.head.extra, i, r, b, _e)), 512 & n.flags && (n.check = v(n.check, i, b, r)), d -= b, r += b, n.length -= b), n.length))
                                    break e;
                                n.length = 0,
                                n.mode = q;
                            case q:
                            ...
                            case de:
                                if (n.wrap) {
                                    ...
                                    if (p -= l, e.total_out += p, n.total += p, p && (e.adler = n.check = n.flags
                                        ? v(n.check, a, p, s - p)
                                        : g(n.check, a, p, s - p)), p = l, (n.flags
                                        ? f
                                        : o(f)) !== n.check) {
                    ...
                    (n.wsize || p !== e.avail_out && n.mode < ce && (n.mode < de || t !== M)) && c(e, e.output, e.next_out, p - e.avail_out)
                        ? (n.mode = fe, U)
                        : (m -= e.avail_in, p -= e.avail_out, e.total_in += m, e.total_out += p, n.total += p, n.wrap && p && (e.adler = n.check = n.flags
                            ? v(n.check, a, p, e.next_out - p)
                            : g(n.check, a, p, e.next_out - p)), e.data_type = n.bits + (n.last
                            ? 64
                            : 0) + (n.mode === W
                            ? 128
                            : 0) + (n.mode === te || n.mode === X
                            ? 256
                            : 0), (0 === m && 0 === p || t === M) && Se === D && (Se = A), Se)
                }
                function h(e) {
                    if (!e || !e.state)
                        return L;
                ...
                if (O > 0 && (e === s || 1 !== F))
                    ...
                    if (e === s
                        ...
                        : e === d
                            ...
                            : (T = f, G = h, x = -1), N = 0, I = 0, R = L, S = b, A = U, B = 0, y = -1, z = 1 << U, _ = z - 1, e === d && z > a || e === l && z > r)
                        return 1;
                    for (var j = 0;;) {
                        j++,
                        M = R - B,
                        ...
                        if (R > U && (N & _) !== y) {
                            for (0 === B && (B = U), S += L, A = R - B, O = 1 << A; F > A + B && (O -= P[A + B], !(0 >= O));)
                                A++,
                                O <<= 1;
                            if (z += 1 << A, e === d && z > a || e === l && z > r)
                                return 1;
                            y = N & _,
                            p[y] = U << 24 | A << 16 | S - b | 0
                        }
                    }
                    return 0 !== N && (p[S + N] = R - B << 24 | 64 << 16 | 0),
                    g.bits = U,
                    0
                }
            }, {
        ...
        "/lib/inflate.js": [
            function(e, t, n) {
                ...
                h.prototype.push = function(e, t) {
                    ...
                    do
                    {
                        if (0 === c.avail_out && (c.output = new r.Buf8(h), c.next_out = 0, c.avail_out = h), n = a.inflate(c, d.Z_NO_FLUSH), n !== d.Z_STREAM_END && n !== d.Z_OK)
                            ...
                            this.ended = !0,
                            !1;
                        c.next_out && (0 === c.avail_out || n === d.Z_STREAM_END || 0 === c.avail_in && (o === d.Z_FINISH || o === d.Z_SYNC_FLUSH)) && ("string" === this.options.to
                    ...
                    ;
                    return n === d.Z_STREAM_END && (o = d.Z_FINISH),
                    o === d.Z_FINISH
                ...
                h.prototype.onEnd = function(e) {
                    e === d.Z_OK && ("string" === this.options.to
...
var browser = function() {
    ...
    hasWebGL = function() {
        ...
        return t || (t = e.getContext("experimental-webgl"))
            ? 1
            : 0
    }(),
    mobile = function(e) {
...
function() {
    var e = function(e) {
        ...
        var s = "function" == typeof Module.locateFile
                ? Module.locateFile(r)
    ...
    e({
        ...
        remote_package_size: 4487536,
        package_uuid: "a0d7ce8d-424c-4866-9553-f543d2b3a44c"
    })
}();
